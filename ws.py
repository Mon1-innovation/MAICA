...
async def check_permit(websocket):
    while True:
        ...
        try:
            ...
            response_str = f"RSA cognition failed, refer to administrator--your ray tracer ID is {traceray_id}"
        ...
        try:
            ...
            if not verification_result[0]:
                response_str = f"Bcrypt hashing failed, refer to administrator--your ray tracer ID is {traceray_id}"
        ...
        try:
            ...
            if 'purge' in request_json:
                try:
                    ...
                    if not purge_result[0]:
                        ...
                        print(f"出现如下异常6-{traceray_id}:{excepted}")
            ...
            match int(chat_session):
                ...
                case i if 0 < i < 10 and i % 1 == 0:
                    ...
                    if check_result[0]:
                        ...
                        if rw_result[0]:
                            ...
                            print(f"出现如下异常12-{traceray_id}:{rw_result[1]}")
                        ...
                        print(f"出现如下异常13-{traceray_id}:{check_result[1]}")
                ...
                case _:
                    ...
                    print(f"出现如下异常15-{traceray_id}:{chat_session}")
                    await websocket.send(wrap_ws_formatter('405', 'wrong_input', response_str, 'warn'))
                    continue
        except Exception as excepted:
        ...
        if chat_session != '0':
            ...
            if stored[0]:
                ...
                if stored[0]:
                    ...
                    print(f"出现如下异常17-{traceray_id}:{stored[1]}")
                ...
                print(f"出现如下异常18-{traceray_id}:{stored[1]}")
                await websocket.send(wrap_ws_formatter('500', 'store_failed', response_str, 'error'))
                return False
