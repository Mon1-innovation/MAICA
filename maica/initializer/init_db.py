...
async def create_tables():
    ...
    EMBEDDING_DIMS = int(load_env('MAICA_EMBEDDING_DIMS'))
...
""",
    ...
    if await vector_pool.has_collection(collection_name=vector_pool.db):
        sync_messenger(info="[maica-db] Milvus collection already exists", type=MsgType.DEBUG)
    else:
        ...
        schema.add_field("vector", DataType.FLOAT_VECTOR, dim=EMBEDDING_DIMS)
