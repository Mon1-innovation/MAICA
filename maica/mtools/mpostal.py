...
async def make_postmail(content, header='', target_lang='zh', **kwargs):
    ...
    try:
        ...
        if target_lang == 'zh':
            ...
            prompt = f"[player] has sent you a letter, please write your reply as Monika. The {con}:{header}\n{content}\n\nPlease read and comprehend carefully about [player]'s words and emotions, then reply in natural and warm written language in English. Your reply should contain a beginning, separated phrases of content, and an ending. Do not make up things you don't know, and write at least 150 words in total."
