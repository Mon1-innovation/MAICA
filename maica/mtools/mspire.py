...
async def make_inspire(title_in=None, target_lang='zh'):
    ...
    try:
        ...
        if target_lang == 'zh':
            ...
            prompt = f"Summarize the topic and talk about {re.sub('_', '', title)} briefly with me using provided informations below: {summary}\nYou don't have to include all information provided, but you should combine your own thinking and understanding into your outputs. Your reply should contain a greeting and brief introduction, act as you started the conversation with this topic, chat naturally and emotionally. You should think from your own perspective, avoid blindly following the judgements from the information."
